      ...
      try {
          String sql=null;
           ...
           rs = stm.executeQuery();
             produtoList.clear();
            while (rs.next()) {
                produtoList.add(new Produto(rs.getInt("id_produto"),rs.getString("nome_produ"),rs.getString("tipo"),rs.getString("nome_marca"),rs.getString("nome_fornecedor"),rs.getDouble("preco"),rs.getInt("quant"),rs.getString("desc_produto") ) );
                }
        } catch (SQLException e) {
            e.printStackTrace();
        }
  ...
  return produtoList;
    ...
    List<Produto> list=new ArrayList();
     try{
       ...
       produtoList.add(new Produto(rs.getString("nome_produ"),rs.getString("tipo"),rs.getString("nome_marca"),rs.getString("nome_fornecedor"),rs.getDouble("preco"),rs.getInt("quant"),rs.getString("desc_produto") ) );
